...
START_TEST(test_is_greater_or_equal_81) {
  // 0
  s21_decimal decimal1 = {{0, 0, 0, 20 << 16}};
  // 0
  s21_decimal decimal2 = {{0, 0, 0, 10 << 16}};
  int check = 1;
  int result = s21_is_greater_or_equal(decimal1, decimal2);
  ck_assert_int_eq(result, check);
}
...
START_TEST(test_is_greater_or_equal_82) {
  // -11
  s21_decimal decimal1 = {{11, 0, 0, (10 << 16 | 1 << 31)}};
  // -10
  s21_decimal decimal2 = {{10, 0, 0, (10 << 16 | 1 << 31)}};
  int check = 0;
  int result = s21_is_greater_or_equal(decimal1, decimal2);
  ck_assert_int_eq(result, check);
}
...
START_TEST(test_is_greater_or_equal_83) {
  // -9
  s21_decimal decimal1 = {{9, 0, 0, (10 << 16 | 1 << 31)}};
  // -10
  s21_decimal decimal2 = {{10, 0, 0, (10 << 16 | 1 << 31)}};
  int check = 1;
  int result = s21_is_greater_or_equal(decimal1, decimal2);
...
Suite *suite_is_greater_or_equal(void) {
  Suite *suite = suite_create("\033[30;43m S21_IS_GREATER_OR_EQUAL \033[0m");
  TCase *tc = tcase_create("tcase__is_greater_or_equal");
  ...
  tcase_add_test(tc, test_is_greater_or_equal_21);
  tcase_add_test(tc, test_is_greater_or_equal_22);
  tcase_add_test(tc, test_is_greater_or_equal_23);
  tcase_add_test(tc, test_is_greater_or_equal_24);
  tcase_add_test(tc, test_is_greater_or_equal_25);
  tcase_add_test(tc, test_is_greater_or_equal_26);
  tcase_add_test(tc, test_is_greater_or_equal_27);
  tcase_add_test(tc, test_is_greater_or_equal_28);
  tcase_add_test(tc, test_is_greater_or_equal_29);
  tcase_add_test(tc, test_is_greater_or_equal_30);
  tcase_add_test(tc, test_is_greater_or_equal_31);
  tcase_add_test(tc, test_is_greater_or_equal_32);
  tcase_add_test(tc, test_is_greater_or_equal_33);
  tcase_add_test(tc, test_is_greater_or_equal_34);
  tcase_add_test(tc, test_is_greater_or_equal_35);
  tcase_add_test(tc, test_is_greater_or_equal_36);
  tcase_add_test(tc, test_is_greater_or_equal_37);
  tcase_add_test(tc, test_is_greater_or_equal_38);
  tcase_add_test(tc, test_is_greater_or_equal_39);
  tcase_add_test(tc, test_is_greater_or_equal_40);
  tcase_add_test(tc, test_is_greater_or_equal_41);
  tcase_add_test(tc, test_is_greater_or_equal_42);
  tcase_add_test(tc, test_is_greater_or_equal_43);
  tcase_add_test(tc, test_is_greater_or_equal_44);
  tcase_add_test(tc, test_is_greater_or_equal_45);
  tcase_add_test(tc, test_is_greater_or_equal_46);
  tcase_add_test(tc, test_is_greater_or_equal_47);
  tcase_add_test(tc, test_is_greater_or_equal_48);
  tcase_add_test(tc, test_is_greater_or_equal_49);
  tcase_add_test(tc, test_is_greater_or_equal_50);
  tcase_add_test(tc, test_is_greater_or_equal_51);
  tcase_add_test(tc, test_is_greater_or_equal_52);
  tcase_add_test(tc, test_is_greater_or_equal_53);
  tcase_add_test(tc, test_is_greater_or_equal_54);
  tcase_add_test(tc, test_is_greater_or_equal_55);
  tcase_add_test(tc, test_is_greater_or_equal_56);
  tcase_add_test(tc, test_is_greater_or_equal_57);
  tcase_add_test(tc, test_is_greater_or_equal_58);
  tcase_add_test(tc, test_is_greater_or_equal_59);
  tcase_add_test(tc, test_is_greater_or_equal_60);
  tcase_add_test(tc, test_is_greater_or_equal_61);
  tcase_add_test(tc, test_is_greater_or_equal_62);
  tcase_add_test(tc, test_is_greater_or_equal_63);
  tcase_add_test(tc, test_is_greater_or_equal_64);
  tcase_add_test(tc, test_is_greater_or_equal_65);
  tcase_add_test(tc, test_is_greater_or_equal_66);
  tcase_add_test(tc, test_is_greater_or_equal_67);
  tcase_add_test(tc, test_is_greater_or_equal_68);
  tcase_add_test(tc, test_is_greater_or_equal_69);
  tcase_add_test(tc, test_is_greater_or_equal_70);
  tcase_add_test(tc, test_is_greater_or_equal_71);
  tcase_add_test(tc, test_is_greater_or_equal_72);
  tcase_add_test(tc, test_is_greater_or_equal_73);
  tcase_add_test(tc, test_is_greater_or_equal_74);
  tcase_add_test(tc, test_is_greater_or_equal_75);
  tcase_add_test(tc, test_is_greater_or_equal_76);
  tcase_add_test(tc, test_is_greater_or_equal_77);
  tcase_add_test(tc, test_is_greater_or_equal_78);
  tcase_add_test(tc, test_is_greater_or_equal_79);
  tcase_add_test(tc, test_is_greater_or_equal_80);
  tcase_add_test(tc, test_is_greater_or_equal_81);
  tcase_add_test(tc, test_is_greater_or_equal_82);
  tcase_add_test(tc, test_is_greater_or_equal_83);
