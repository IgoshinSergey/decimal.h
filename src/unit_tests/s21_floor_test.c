...
Suite *suite_floor(void) {
  ...
  TCase *tc = tcase_create("tcase_floor");
  ...
  tcase_add_test(tc, test_floor_ok61);
  tcase_add_test(tc, test_floor_ok62);
  tcase_add_test(tc, test_floor_ok63);
  tcase_add_test(tc, test_floor_ok64);
  tcase_add_test(tc, test_floor_ok65);
  tcase_add_test(tc, test_floor_ok66);
  tcase_add_test(tc, test_floor_ok67);
  tcase_add_test(tc, test_floor_ok68);
  tcase_add_test(tc, test_floor_ok69);
  tcase_add_test(tc, test_floor_ok70);
  tcase_add_test(tc, test_floor_ok71);
  tcase_add_test(tc, test_floor_ok72);
  tcase_add_test(tc, test_floor_ok73);
  tcase_add_test(tc, test_floor_ok74);
  tcase_add_test(tc, test_floor_ok75);
  tcase_add_test(tc, test_floor_ok76);
  tcase_add_test(tc, test_floor_ok77);
  tcase_add_test(tc, test_floor_ok78);
  tcase_add_test(tc, test_floor_ok79);
  tcase_add_test(tc, test_floor_ok80);
