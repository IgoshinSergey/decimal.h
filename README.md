...
Функция s21_round:
```C
// value_1: мантисса 123450, знак +, коэффициент масштабирования 2
// 1234.50
s21_decimal value = {{123450, 0, 0, 2 << 16}};

s21_decimal result = {0};
s21_round(value, &result);
// result: мантисса 1234, знак +, коэффициент масштабирования 0
// 1234, использовалось банковское округление (округление к ближайшему четному числу)
```
